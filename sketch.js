...
var playerArcherLife = 3
  ...
  function setup() {
    ...
    computerArcher = new ComputerArcher(width - 350,computerBase.body.position.y - 180,120,120);
  ...
  function showArrows(index, arrows) {
    ...
    if(
      ...
      if(!arrows[index].isRemoved){
        ...
        //trajectory spelling is corrected
  ...
  function handleComputerArcher() {
    if (!computerArcher.collapse && !playerArcher.collapse) {
      setTimeout(() => {
        ...
        //added and condition for computer archer angle
